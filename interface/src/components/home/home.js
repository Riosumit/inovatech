    ...
    <div>
      <div className="content">
        ...
        <div className="provide">
          <div className="heading"><b>What we provide for new Inovators?</b></div>
          <div className="write">We provide a platform for young innovators to showcase their groundbreaking ideas. We understand the importance of encouraging young people to think creatively and bring new ideas to the forefront. Our platform provides a safe and supportive environment for young minds to develop and present their innovative ideas to the world. We recognize that many young people possess an incredible amount of talent and creativity, but often lack the resources and opportunities to bring their ideas to life. Our platform aims to bridge this gap by providing a space for young innovators to showcase their ideas to potential investors, mentors, and collaborators.</div>
        </div>
        <div className="faq">
          <div className="heading"><b>FAQ's</b></div>
